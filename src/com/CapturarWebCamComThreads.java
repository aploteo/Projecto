package com;
	...
	public class CapturarWebCamComThreads {
		...
		public static void main(String[] args) {
			...
			while (true) {
				...
				String fileC = "C:\\Tnlenterprises\\Timelapse\\frames\\20171116\\"
						+ new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss-SSS").format(new Date()) + ".jpg";
				String fileD = "D:\\frames\\20171116\\" + fileC.substring(44);
...
//					ImageIO.write(image, "jpg", new File(fileD));
				...
				if (contagem == 5) {
					t = new Thread() {
						public void run() {
							System.out.println(imageInByte + " | " + fileC.substring(44));
